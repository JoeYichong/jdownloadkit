...
public class Config extends PropertyFiles {
    ...
    final public static Item DOWNLOAD = item("_config/download.properties");
    ...
    public static String COLLECTOR_DETECTOR;
    ...
    static {
        try {
            DIR_COPY_FROM = Paths.get(DOWNLOAD.getProperty("dir.copy.source"));
            DIR_COPY_TO = Paths.get(DOWNLOAD.getProperty("dir.copy.destination"));
            DIR_GEN_TO = Paths.get(DOWNLOAD.getProperty("dir.gen.destination"));
            COLLECTOR_INTERVAL = Integer.parseInt(DOWNLOAD.getProperty("collector.interval"));
            COLLECTOR_DEL_SRC = Boolean.parseBoolean(DOWNLOAD.getProperty("collector.delSrc"));
            COLLECTOR_DETECTOR = DOWNLOAD.getProperty("collector.detector");
            MERGER_SUFFIX = DOWNLOAD.getProperty("merger.suffix");
            MERGER_TAG = "".equals(MERGER_TAG = DOWNLOAD.getProperty("merger.tag")) ? null : MERGER_TAG;
            MERGER_DEL_SRC = Boolean.parseBoolean(DOWNLOAD.getProperty("merger.delSrc"));;
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("COLLECTOR_DETECTOR: " + COLLECTOR_DETECTOR);
